...
const PortalPopup: FunctionComponent<PopupProps> = ({
  ...
  useEffect(() => {
    ...
    document.body.classList.toggle("overflow-hidden", !!relContainerRef.current);

    // Call the onOutsideClick function when the popup is closed
  ...
  }, [relContainerRef.current, onOutsideClick]);
    ...
    if (!relativeLayerRef?.current) {
      switch (placement) {
        case "Centered":
          ...
          style.transform = "translate(180px, 85px)";
          break;
        case "Top left":
