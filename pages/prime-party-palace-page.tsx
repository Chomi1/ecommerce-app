...
const PrimePartyPalacePage: NextPage = () => {
  return (
    ...
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-center justify-start pt-0 px-0 pb-0 box-border leading-[normal] tracking-[normal]">
      ...
      <section className="flex flex-row items-start justify-start relative max-w-full text-center text-45xl text-floralwhite font-aeonik">
        <h1 className="!m-[0] w-[990px] absolute bottom-[284px] left-[calc(50%_-_495px)] text-inherit leading-[64px] font-medium font-[inherit] inline-block z-[2] mq450:text-19xl mq450:leading-[38px] mq1050:text-32xl mq1050:leading-[51px]">
          Prime party palace: Your premier venue for magical events
        </h1>
        <div className="w-[1440px] bg-white flex flex-col items-start justify-start pt-0 px-px pb-[25px] box-border gap-[25px] max-w-full">
          <div className="self-stretch h-[794px] relative bg-white hidden" />

          <div className="self-stretch flex flex-row items-start justify-start py-0 px-[19px] box-border max-w-full">
            <img
...
export default PrimePartyPalacePage;
